...
class Logger {
  ...
  static final Logger _instance = Logger._create();
...
void logDebugFinest(String message) {
  __log('', message, LogLevel.debugFinest);
}

void logDebugFiner(String message) {
  __log('', message, LogLevel.debugFiner);
}

void logDebugFine(String message) {
  __log('', message, LogLevel.debugFine);
}

void logDebug(String message) {
  __log('', message, LogLevel.debug);
}

void logInfo(String message) {
  __log('', message, LogLevel.info);
}

void logSuccess(String message) {
  __log('', message, LogLevel.success);
}

void logWarning(String message) {
  __log('', message, LogLevel.warning);
}

void logError(String message) {
  __log('', message, LogLevel.error);
}

void logErrorObject(Object error, String message) {
  __log('', message, LogLevel.error, object: error);
}
